# Introducción:
En este ejercicio nos enseña a dar resolución a un problema importante a tener en cuenta, las listas o bases de datos con las que trabajamos no contienen exclusivamente el tipo de dato que esperamos, por lo que intentar realizar operaciones matemáticas directamente sobre todos los elementos provocaría un error del programa.

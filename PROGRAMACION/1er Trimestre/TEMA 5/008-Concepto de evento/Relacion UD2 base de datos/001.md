# Introducción:
Este ejercicio consiste en crear una aplicación de consola en Python que permita gestionar un portafolio de piezas creativas utilizando operaciones CRUD (Crear, Leer, Actualizar, Borrar) en una base de datos MySQL. La aplicación debe conectarse a la base de datos utilizando un usuario seguro y proporcionar un menú interactivo para que el usuario pueda realizar las diferentes operaciones.
...
---
# Conclusión:
Gracias a este ejercicio, hemos creado una aplicación de consola en Python que interactúa con una base de datos MySQL para gestionar un portafolio de piezas creativas. 
La aplicación permite realizar operaciones CRUD de manera segura utilizando consultas parametrizadas, y proporciona una interfaz sencilla para el usuario.

# Introducción: 
Este ejercicio consiste en unir el examen de Base de datos, lenguaje de marcas y programación para crear una aplicación web que muestre un portafolio de piezas creativas almacenadas en una base de datos MySQL. 
El objetivo principal es mostrar cómo se pueden integrar diferentes tecnologías para crear una aplicación web dinámica y funcional.
...
---
# Conclusión:
Este ejercicio demuestra cómo se pueden combinar diferentes tecnologías para crear una aplicación web dinámica que interactúa con una base de datos. Utilizando Flask para el backend y MySQL para el almacenamiento de datos, así logrando desarrollar una plataforma sencilla para mostrar un portafolio de piezas creativas.

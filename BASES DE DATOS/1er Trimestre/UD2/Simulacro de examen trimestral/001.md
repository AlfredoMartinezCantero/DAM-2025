# Introducción:
En este ejercicio aprendemos a crear y geestionar una base de datos en MySQL para un portafolio. Incluiremos:
La creación de la BBDD, tablas relacionales, inserción de datos de ejemplo, consultas simples y avanzadas (JOIN), y, por último, creación y consulta de una vista (VIEW)
El objetivo es practivar la estructura y manipulación de datos.
...
---
# Conclusión:
A través de este ejercicio se aprende a estructurar y organizar información en MySQL gracias a la creación de tablas relacionadas. 
También hemos insertado datos de ejemplo y realizado consultas que combinan información de múltiples tablas mediante JOIN.
